...
def _get_models():
    ...
    if not tokenizer or not model:
        tokenizer = DistilBertTokenizer.from_pretrained(BASE_DIR / "models/model_15_1e5")
        model = DistilBertForSequenceClassification.from_pretrained(BASE_DIR / "models/model_15_1e5")
